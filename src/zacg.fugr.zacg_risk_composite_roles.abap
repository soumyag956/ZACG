FUNCTION zacg_risk_composite_roles.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  ...
  SELECT agr_name, child_agr
    ...
    WHERE agr_name = @it_role-agr_name
  ...
  IF sy-subrc IS INITIAL.
    ...
    lr_comp = VALUE #( FOR lw_agr_agrs IN  li_agr_agrs ( sign = 'I' option = 'EQ' low = lw_agr_agrs-agr_name  ) ).
    SORT lr_comp BY low.
